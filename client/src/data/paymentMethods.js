const basePaymentMethods = [
  {
    ...
    pros: ["No or minimal transaction charges", "Instant settlement for most merchants", "Works 24/7 with strong bank support"],
    cons: ["Requires bank-linked mobile setup", "Occasional failure during bank downtime"],
  ...
  },
  {
    ...
    pros: ["Strong authentication layers", "Good for larger checkout amounts", "Direct bank settlement"],
    cons: ["Slower than UPI or cards", "Bank maintenance windows affect availability"],
  ...
  },
  {
    ...
    pros: ["Excellent merchant acceptance", "Rewards, cashback, and EMI options", "Chargeback support for disputes"],
    cons: ["Can attract convenience fees", "Risk of over-spending if unmanaged"],
  ...
  },
  {
    ...
    pros: ["Direct bank deduction keeps spending controlled", "Commonly accepted across merchants", "Lower cost than credit card usage in many cases"],
    cons: ["Limited rewards compared to credit cards", "Some banks impose transaction limits"],
  ...
  },
  {
    ...
    pros: ["Very quick checkout flow", "Promotions and cashback offers", "Useful for repeat purchases"],
    cons: ["Merchant acceptance is not universal", "Wallet balance management adds friction"],
    idealFor: ["Offer-driven shopping", "Fast mobile checkout"],
    security: ["PIN/biometric login", "Tokenized payments", "Wallet alerts"]
  }
];

function clone(methods) {
...
export const paymentMethods = clone(basePaymentMethods);
